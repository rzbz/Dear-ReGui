...
ReGui:DefineTheme("Cherry", {
	...
	InputsBg = Color3.fromRGB(25, 20, 25),
	CheckboxBg = Color3.fromRGB(25, 20, 25),
	ComboBg = Color3.fromRGB(25, 20, 25),
	ActiveTabBg = Color3.fromRGB(150, 100, 150),
	InputsGrabColor = Color3.fromRGB(150, 100, 150),
	ButtonsBg = Color3.fromRGB(150, 100, 150),
	CollapsingHeaderBg = Color3.fromRGB(150, 100, 150),
	CheckboxTick = Color3.fromRGB(150, 100, 150),
	WindowBg = Color3.fromRGB(35, 30, 35),
	TitleBarBg = Color3.fromRGB(35, 30, 35),
	ActiveTitleBarBg = Color3.fromRGB(50, 45, 50),
	Border = Color3.fromRGB(50, 45, 50),
	TabBg = Color3.fromRGB(25, 20, 25),
	...
	TabsBarBg = Color3.fromRGB(150, 100, 150), -- CUSTOM
	TabPadding = UDim.new(0, 0),
})
